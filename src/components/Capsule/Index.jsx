  ...
  return (
    ...
    >
        <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start " >
            ...
            Bloom is like a digital garden, where every interaction is a seed planted for something greater.
            </h1>
            <div className="heading">
                <h1 className="font-[SansitaReg] text-[5vh] leading-[6.5vh] sm:text-[8vh] py-5 sm:leading-[9vh]">Explore <br/> Our Insights</h1>
                <Button bgColor="bg-[#f5f19c]" text="VIEW MORE" />
            </div>
        </div>
        <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
            ...
            <div   
                ...
                <div className="text text-center text-[6vw] sm:text-[3.2vh] font-semibold mt-10 leading-[4.8vh]">
                    <h3>Bloom envisions a world where technology 
                    enhances well-being, encourages positivity, 
                    and strengthens authentic human connections.
                    </h3>
                </div>
                <button className="bg-[#e9bbff] text-black px-4 rounded-full text-medium py-3 mb-10 mt-10 font-semibold">Thought Technology</button>
            ...
            <div   
                ...
                rounded-full border-[1px] border-black"
            >
                    <button className="bg-[#e9bbff] text-black px-4 rounded-full text-medium py-3 mb-6 mt-10 font-semibold">Thought Innovation</button>
                
                <div className="text text-center text-[3.2vh] flex flex-col gap-6 mb-6 font-semibold leading-[4.8vh]">
                    <h3>We strive to replace the draining nature of traditional 
                    social media with a space that cultivates inspiration, 
                    purpose, and genuine connections.
                    </h3>
                    <h4 className="font-[Sansita] text-[1.9vh] font-medium leading-[2.8vh] text-zinc-500">Bloom is committed to transforming online interactions into meaningful connections<br/>
