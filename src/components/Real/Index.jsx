        ...
        >
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        We're on a mission to impact as many lives as possible and build a better company while we do it, because
                    </h3>
                    ...
                    <h3 className=' text-[2vh] sm:text-[5vh] font-semibold sm:leading-[7vh]'>
                        of social media users report feeling more anxious or stressed after prolonged use.
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        Replacement, not elimination, is the way forward.
                    </h3>
                    <h1 className=' font-semibold text-[10vh] sm:text-[20vh] leading-none text-white'>
                        64%
                    </h1>
                    <h3 className='text-[3.5vh] sm:text-[6vh] font-semibold sm:leading-[6vh]'>
                        of people feel that traditional social 
                        media negatively impacts their mental health
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>                   
                    ...
                    <h3 className='text-[3.1vh] leading-[3.4vh] sm:text-[6vh] font-semibold sm:leading-[8vh]'>
                        of users agree that they would prefer a platform promoting personal growth
                    </h3>    
                </div>
                <div 
